  ...
  return (
    <LabSection id="lab">
      <Container>
        <Rail>
          <RailLabel>
            <RailHeading>{labLabel}</RailHeading>
            <RailNote>
              {counter}
              <br />
              {labHint}
