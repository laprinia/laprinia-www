...
export const personJobTitle = "Product Designer";
...
export const personDescription =
  "Product Designer and Developer in Bucharest. Five years of user research, interaction design and design systems, shipped into production.";
